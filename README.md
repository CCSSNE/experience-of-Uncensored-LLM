...
千问3.5，如果没有官方的关闭思考，那就在，模型页面的Inference 最下方的模板添加一句
...
还有个邪修方法
你用 lm studio 官方的那个把这个31b 的模型下载下来   然后你把它官方下载下来的那个文件夹保留，但是文件给删掉，替换成我的这个破解版，就可以直接在前端控制他是否思考了 
其实原理就是
C:\Users\user\.lmstudio\hub\models\qwen\qwen3.5-9b\model.yaml 这个文配置文件里面增加一个自定义字段
```
customFields:
  - key: enableThinking
